...
public class MultiplaEmbaralhada {
	...
	public static void main(String[] args) {
		...
		respostas.add(a);		
		String b = "b) A base deve ser multiplicada pela potencia correspondente e a soma deve ser feita com o resultado da multiplicação";
		respostas.add(b);
		...
		System.out.println("C.C - Referente a conversão de binário para decimal, assinale a alternativa correta:");
		
		System.out.println(
				"a) Deve ser dividido e multiplicado pela potencia para chegar ao resultado");	
		System.out.println(
				"b) A base deve ser multiplicada pela potencia correspondente e a soma deve ser feita com o resultado da multiplicação");
		System.out.println(
